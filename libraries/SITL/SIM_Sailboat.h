...
private:
    ...
    float get_roll_overturning_torque( float heel_force_N,float heel_angle_rad)const;
    float get_roll_righting_torque( float heel_angle_rad) const;
    float get_roll_damping_torque(float roll_rat_rad_per_s)const;
